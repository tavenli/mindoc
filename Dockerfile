...
#RUN mkdir -p /go/src/github.com/lifei6671/ && cd /go/src/github.com/lifei6671/ && git clone https://github.com/tavenli/mindoc.git && cd mindoc

ADD . /go/src/github.com/tavenli/mindoc

WORKDIR /go/src/github.com/tavenli/mindoc
...
ADD start.sh /go/src/github.com/tavenli/mindoc
...
COPY --from=build /go/src/github.com/tavenli/mindoc /mindoc
